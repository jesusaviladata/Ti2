...
app.include_router(agent_storage.router, prefix="/api/v1/agent-storage", tags=["agent-storage"])
app.include_router(agent_profiles.router, prefix="/api/v1/agents", tags=["agent-profiles"])
